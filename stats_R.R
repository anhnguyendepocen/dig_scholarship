...
# independent variable, type (numerical continuous or discrete counts) = 
...
# YOUR REGRESSION - LINEARITY: Plot your y ~ x to check if the relationship is linear
#
#
# linear? = 
...
# YOUR REGRESSION - RESIDUALS: Create an object of your residuals 
#
#
...
# 2.a) Check for NORMALITY with a probability (= quantile or Q-Q) plot # ---------------------------
...
# YOUR REGRESSION - NORMAL DISTRIBUTION: Create a qq plot & qqline of your residuals
#
#
...
# YOUR REGRESSION - INDEPENDENCE: Plot (residuals ~ x variable)
#
#
# residuals independent of explanatory variable? = 




# 2.c) Check for IDENTICALLY DISTRIBUTED residuals (homoscedasticity) # ----------------------------
...
# YOUR REGRESSION - IDENTICAL DISTRIBUTION: Plot (y ~ x) and add your regression line 
#
#
# identical distance of each data point to regression line? = 




# YOUR REGRESSION - SYNTHESIS: Does your model meet basic linear regression assumptions?
#
#
